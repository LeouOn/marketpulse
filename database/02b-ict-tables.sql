...
CREATE INDEX IF NOT EXISTS idx_fvg_symbol_time ON market_data.fair_value_gaps (symbol, formation_timestamp DESC);
CREATE INDEX IF NOT EXISTS idx_fvg_filled ON market_data.fair_value_gaps (is_filled);
CREATE INDEX IF NOT EXISTS idx_fvg_type ON market_data.fair_value_gaps (type);
...
CREATE INDEX IF NOT EXISTS idx_ob_symbol_time ON market_data.order_blocks (symbol, formation_timestamp DESC);
CREATE INDEX IF NOT EXISTS idx_ob_status ON market_data.order_blocks (is_tested, is_broken);
CREATE INDEX IF NOT EXISTS idx_ob_strength ON market_data.order_blocks (strength DESC);
...
CREATE INDEX IF NOT EXISTS idx_liq_symbol_time ON market_data.liquidity_pools (symbol, formation_timestamp DESC);
CREATE INDEX IF NOT EXISTS idx_liq_swept ON market_data.liquidity_pools (is_swept);
CREATE INDEX IF NOT EXISTS idx_liq_type ON market_data.liquidity_pools (type);
...
CREATE INDEX IF NOT EXISTS idx_ms_symbol_time ON market_data.market_structure (symbol, timestamp DESC);
CREATE INDEX IF NOT EXISTS idx_ms_type ON market_data.market_structure (structure_type);
CREATE INDEX IF NOT EXISTS idx_ms_event ON market_data.market_structure (event_type);
...
CREATE INDEX IF NOT EXISTS idx_ict_signal_symbol_time ON analysis.ict_signals (symbol, signal_timestamp DESC);
CREATE INDEX IF NOT EXISTS idx_ict_signal_type ON analysis.ict_signals (signal_type);
CREATE INDEX IF NOT EXISTS idx_ict_signal_trigger ON analysis.ict_signals (trigger);
CREATE INDEX IF NOT EXISTS idx_ict_signal_outcome ON analysis.ict_signals (outcome);
...
CREATE INDEX IF NOT EXISTS idx_of_symbol_time ON market_data.order_flow (symbol, timestamp DESC);
CREATE INDEX IF NOT EXISTS idx_of_imbalance ON market_data.order_flow (has_imbalance, imbalance_type);
CREATE INDEX IF NOT EXISTS idx_of_absorption ON market_data.order_flow (has_absorption);
...
CREATE INDEX IF NOT EXISTS idx_div_symbol_time ON analysis.delta_divergences (symbol, signal_timestamp DESC);
CREATE INDEX IF NOT EXISTS idx_div_type ON analysis.delta_divergences (divergence_type);
CREATE INDEX IF NOT EXISTS idx_div_outcome ON analysis.delta_divergences (resulted_in_reversal);
...
CREATE INDEX IF NOT EXISTS idx_session_symbol_time ON market_data.trading_sessions (symbol, session_start DESC);
CREATE INDEX IF NOT EXISTS idx_session_name ON market_data.trading_sessions (session_name);
...
CREATE INDEX IF NOT EXISTS idx_perf_symbol ON analysis.ict_signal_performance (symbol);
CREATE INDEX IF NOT EXISTS idx_perf_trigger ON analysis.ict_signal_performance (trigger_type);
CREATE INDEX IF NOT EXISTS idx_perf_winrate ON analysis.ict_signal_performance (win_rate DESC);
