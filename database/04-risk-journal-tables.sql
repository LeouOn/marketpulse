...
CREATE INDEX IF NOT EXISTS idx_positions_entry_time ON trading.positions(entry_timestamp DESC);
CREATE INDEX IF NOT EXISTS idx_positions_exit_time ON trading.positions(exit_timestamp DESC);
CREATE INDEX IF NOT EXISTS idx_positions_setup_type ON trading.positions(setup_type);
...
CREATE INDEX IF NOT EXISTS idx_daily_stats_date ON trading.daily_stats(trade_date DESC);
...
CREATE INDEX IF NOT EXISTS idx_risk_events_time ON trading.risk_events(event_timestamp DESC);
...
CREATE INDEX IF NOT EXISTS idx_perf_period ON trading.performance_analytics(period_type, period_end DESC);
...
CREATE INDEX IF NOT EXISTS idx_setup_perf_type ON trading.setup_performance(setup_type);
CREATE INDEX IF NOT EXISTS idx_setup_perf_pf ON trading.setup_performance(profit_factor DESC);
...
CREATE INDEX IF NOT EXISTS idx_session_perf_session ON trading.session_performance(session);
CREATE INDEX IF NOT EXISTS idx_session_perf_pnl ON trading.session_performance(total_pnl DESC);
...
CREATE INDEX IF NOT EXISTS idx_alerts_type ON trading.alert_history(alert_type);
CREATE INDEX IF NOT EXISTS idx_alerts_priority ON trading.alert_history(priority);
CREATE INDEX IF NOT EXISTS idx_alerts_time ON trading.alert_history(alert_timestamp DESC);
CREATE INDEX IF NOT EXISTS idx_alerts_position ON trading.alert_history(related_position_id);
...
CREATE INDEX IF NOT EXISTS idx_equity_time ON trading.equity_curve(timestamp DESC);
