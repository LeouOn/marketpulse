...
async def test_alpaca_connection():
    ...
    try:
        ...
        if (
            settings.api_keys.alpaca.key_id == "your_alpaca_key_here"
            or settings.api_keys.alpaca.secret_key == "your_alpaca_secret_here"
        ):
...
async def run_comprehensive_alpaca_test():
    ...
    # Test results
    results = {"connection": False, "internals": False, "multiple_symbols": False}
