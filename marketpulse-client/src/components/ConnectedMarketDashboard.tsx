        ...
        {dashboardData?.data && 'marketBias' in dashboardData.data && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <motion.div
              ...
              className={`p-6 rounded-xl border ${getBiasColor(String(dashboardData.data.marketBias || ''))}`}
            >
              <h3 className="text-lg font-semibold mb-2">Market Bias</h3>
              <p className="text-2xl font-bold capitalize">{String(dashboardData.data.marketBias || 'Unknown')}</p>
            </motion.div>
            ...
            <motion.div
              ...
              className={`p-6 rounded-xl border ${getVolatilityColor(String(dashboardData.data.volatilityRegime || ''))}`}
            >
              <h3 className="text-lg font-semibold mb-2">Volatility Regime</h3>
              <p className="text-2xl font-bold capitalize">{String(dashboardData.data.volatilityRegime || 'Unknown')}</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-2xl font-bold">{String(dashboardData.data.market_session || 'Unknown')}</p>
            </motion.div>
          </div>
        )}
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {Object.entries(macroData.data).map(([symbol, data], index) => {
                if (typeof data !== 'object' || data === null || !('price' in data)) return null;
