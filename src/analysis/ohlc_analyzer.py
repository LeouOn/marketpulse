...
class OHLCAnalyzer:
    ...
    def _extract_ohlc_data(self, data: dict[str, Any], timeframe: str, symbol: str) -> pd.DataFrame | None:
    ...
    def _generate_sample_data(self, symbol: str, timeframe: str) -> list[dict]:
        ...
        base_price = {"SPY": 450.0, "QQQ": 380.0, "BTC": 45000.0, "ETH": 2400.0, "VIX": 16.0}.get(symbol, 100.0)
        ...
        try:
            ...
            if len(recent) >= 3:
                ...
                if (
                    ...
                    and body_size / (hammer["high"] - hammer["low"]) < 0.3
                ):
                    patterns.append(
                        {
                            "name": "Hammer",
            ...
            if len(recent) >= 2:
                ...
                if (
                    ...
                    and second["close"] > second["open"]  # Second is green
                    and second["open"] < first["close"]  # Second opens below first close
                    and second["close"] > first["open"]
                ):  # Second closes above first open
                    patterns.append(
                        {
                ...
                # Bearish engulfing
                    ...
                    and second["close"] < second["open"]  # Second is red
                    and second["open"] > first["close"]  # Second opens above first close
                    and second["close"] < first["open"]
                ):  # Second closes below first open
                    patterns.append(
                        {
