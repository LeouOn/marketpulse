...
class PositionScaler:
    ...
    def calculate_kelly_size(self, stats: ScalingStats) -> float:
        """
    ...
    def _get_sizing_reason(self, stats: ScalingStats, signal_strength: float, size: int) -> str:
...
def calculate_performance_stats(trades: List[Any]) -> ScalingStats:
    """
