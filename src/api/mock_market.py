...
Adds realistic variance around real prices.
"""
...
class MockMarketDataProvider:
    ...
    def _generate_volume(self, symbol: str) -> int:
        base_volumes = {
            'SPY': 45_000_000, 'QQQ': 32_000_000, 'VIX': 15_000_000,
            'IWM': 28_000_000, 'DIA': 18_000_000, 'AAPL': 55_000_000,
            'TSLA': 95_000_000, 'NVDA': 42_000_000,
        }
        return int(base_volumes.get(symbol, 20_000_000) * random.uniform(0.5, 2.0))
