...
class MarketBreadthCollector:
    ...
    def _calculate_advance_decline(self) -> dict[str, Any]:
        ...
        try:
            ...
            self.ad_history.append({"date": datetime.now(), "net_ad": total_net_ad})
    ...
    def _calculate_highs_lows(self) -> dict[str, Any]:
        ...
        try:
            ...
            return {"new_highs": 0, "new_lows": 0, "hl_ratio": 1.0, "net_hl": 0, "interpretation": "Neutral"}
    ...
    def _calculate_tick_proxy(self) -> dict[str, Any]:
        ...
        try:
            ...
            return {"tick_value": 0, "tick_30min_avg": 0, "tick_4hr_avg": 0, "interpretation": "Neutral"}
    ...
    def _calculate_vold(self) -> dict[str, Any]:
        ...
        try:
            ...
            return {"nyse_vold": 0, "nasdaq_vold": 0, "total_vold": 0, "interpretation": "Neutral"}
    ...
    def _calculate_mcclellan(self) -> dict[str, Any]:
        ...
        try:
            if len(self.ad_history) < 39:
                ...
                return {"mcclellan_oscillator": 0, "mcclellan_summation": 0, "interpretation": "Insufficient data"}
            ...
            return {"mcclellan_oscillator": 0, "mcclellan_summation": 0, "interpretation": "Neutral"}
